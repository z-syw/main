...
console.log("userName=" + student.userName + ",userAge=" + student.userAge + ",gender=" + student.gender)
```
...
```javascript
<script>
  // 使用var使用声明变量 var userName = "bxg"; console.log("userName=", userName); // 使用let声明变量 let userAge = 18;
...
```js
<script>
  let arr = [1, 2, 3, 4, 5, 6]; let [arr1, ...arr2] = arr; //进行解构处理 console.log(arr1); // 1 console.log(arr2); //
  [2,3,4,5,6]
</script>
```
